...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PrivacyPoliciesPageWidget.routeName,
          path: PrivacyPoliciesPageWidget.routePath,
          builder: (context, params) => PrivacyPoliciesPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AnnouncementsDetailsWidget.routeName,
          path: AnnouncementsDetailsWidget.routePath,
          builder: (context, params) => AnnouncementsDetailsWidget(
            announcementRef: params.getParam(
              'announcementRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['announcements2'],
            ),
          ),
        ),
        FFRoute(
